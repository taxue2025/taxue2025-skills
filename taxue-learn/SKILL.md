...
description: |
  ...
  触发：/taxue-learn、怎么高效学习、学了记不住怎么办、费曼学习法、AI辅助学习、怎么内化一篇文章
  边界：知识内化（不是问题解决，不是系统构建）。想「解决」→ taxue-solve。想「固化」→ taxue-build。
---

## 完整触发条件（原始 description）

踏雪学习方法论。从信息输入到能力输出的四步内化法。 触发：/taxue-learn、怎么高效学习、学了记不住怎么办、费曼学习法、AI辅助学习、怎么内化一篇文章 边界：知识内化（不是问题解决，不是系统构建）。想「解决」→ taxue-solve。想「固化」→ taxue-build。
...
*taxue-learn v2.7 — 四步内化 · 认知失调迭代 · AI 学习导师 · 图尔明验证 · 认知位移记录*
